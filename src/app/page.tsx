    ...
    <div className="flex items-center flex-col justify-center">
      <div className="container flex flex-1">
        ...
        <main className="flex-1 relative h-full">
          ...
          <button className="text-blue-500 w-full p-3 text-center hover:bg-gray-200 border border-gray-300">
            Show 33 Guin
          </button>
        ...
        <aside className="sticky top-0 h-full p-6  hidden lg:block sm:w-48 md:w-64">hey</aside>
      </div>
    </div>
  );
}
